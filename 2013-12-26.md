...
Going back to my previous crypto notes, I noticed how ugly the math typesetting is. Apparently others have tried to use Github + MathJax to handle this, but with very little luck.
